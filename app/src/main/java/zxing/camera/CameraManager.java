...
//			int width = Util.dip2px(context, SCAN_FRAME_WIDTH);
//			int height = Util.dip2px(context, SCAN_FRAME_HEIGHT);
//			int leftOffset = (screenResolution.x - width) / 2;
//			int topOffset = (screenResolution.y - height) / 2;
//
//			// 真正的取景框大小
//			framingRect = new Rect(leftOffset, topOffset, leftOffset + width, topOffset + height / 2);
...
//
//			LogUtil.d(TAG,"设置矩形框高度--》"+height);
//			LogUtil.d(TAG,"设置矩形框宽度--》"+width);
//
//			int leftOffset = (screenResolution.x - width) / 2;
//			int topOffset = (screenResolution.y - height) / 2;
